...
> extends LitElement {
   ...
   * @see https://blockprotocol.org/spec/graph-module#message-definitions for a full list of available messages
   */
  ...
  static properties = {
     ...
     * @see https://blockprotocol.org/spec/graph-module#message-definitions for a full list
     */
    graph: { type: Object },
  };
