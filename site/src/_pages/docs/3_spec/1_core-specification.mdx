...
The `@blockprotocol/core` package exports a `renderHtmlBlock` function which does the below for embedding applications.
...
The `@blockprotocol/core` package exports a `assignBlockprotocolGlobals` object which assign an object implementing these functions to the `blockprotocol` global variable.
