...
The [core specification](/docs/spec/core-specification) sets out how blocks should be defined, how services are defined, how embedding applications should initialize blocks, and _how_ applications and blocks communicate.
