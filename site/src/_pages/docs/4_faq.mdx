...
Moving beyond a single set of constrained schemas that rarely change introduces new issues. We believe that all of these issues can be mitigated and that the benefits of an open ecosystem of well-described, discoverable types grealy outweigh the drawbacks.
