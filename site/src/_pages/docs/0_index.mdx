...
- [develop blocks](/docs/developing-blocks) and publish them to the block registry
- [embed blocks](/docs/embedding-blocks) within an application or allow an app's users to dynamically do the same

For the full technical details, read [the Block Protocol specification](/spec).

If you have any questions, [please open or contribute to a discussion](https://github.com/blockprotocol/blockprotocol/discussions). You can also [chat to us on Discord](/discord).
...
Any block can become a Block Protocol block by meeting the requirements defined in the BP [specification](/spec). These requirements define what data a block can accept and how they're allowed to edit that data.
