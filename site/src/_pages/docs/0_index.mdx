...
- [embed blocks](/docs/embedding-blocks) within an application
...
BP blocks can also be published to the [Hub](/hub) – an open-source registry where anyone can publish their blocks for other people to discover and use.

Any application can accept BP blocks, as long as they follow the [requirements for embedding applications](/docs/embedding-blocks).
