...
1.  Add a JSON file [to the hub folder](https://github.com/blockprotocol/blockprotocol/tree/main/hub), in a subfolder with the namespace you want to grab, preceded by @ (e.g. `@mynamespace`)
