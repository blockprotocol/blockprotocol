...
Blocks are discrete components of functionality. You can write them using React, a ready-made library for writing components.
If you need it, here’s [an intro to React](https://reactjs.org/docs/getting-started.html).

Note: you can also define blocks in other ways - we are exploring alternative approaches and will expand our guidance. This guide describes how to write them in React.
