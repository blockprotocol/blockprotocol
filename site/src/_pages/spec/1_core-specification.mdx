...
The `data` and `errors` of any messages exchanged between applications and blocks, and not described in [Core messages](#core-messages), MUST be described in separate service specifications.
...
- MUST define any messages and metadata it introduces in a JSON file conforming to this schema
