...
As we develop this application further, we will test various rendering strategies in it, and provide abstractions for embedding applications to minimise the amount of work required to use blocks.
