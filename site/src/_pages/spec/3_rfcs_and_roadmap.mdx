...
We welcome suggestions for other services that may be useful, via GitHub [discussions](https://github.com/blockprotocol/blockprotocol/discussions).
...
2.  **Self-contained block (addition or alternative)**
