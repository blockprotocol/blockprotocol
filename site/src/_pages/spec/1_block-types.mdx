...
- `operation`: the aggregation operation applied:
  - `entityTypeId?` \[_object_]\[_optional_]:: the specific type results were limited to
  - `entityTypeVersionId?` \[_object_]\[_optional_]:: the specific version of a type results were limited to
