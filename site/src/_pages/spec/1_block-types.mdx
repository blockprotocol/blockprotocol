...
- a JSON file containing **metadata describing the block**, which:
  ...
  - MUST specify:
    ...
    - a `name` for the block. This should be **unique**, as it's used as a slug wherever required.
  ...
  - SHOULD specify:
    ...
    - `repository`: a link to your block's repository. This is helpful for people who want to contribute.
