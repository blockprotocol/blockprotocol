...
| -------------------- | ------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| OpenAI               | DALL-E, GPT-3 Ada, GPT-3 Babbage, GPT-3 Curie, GPT-3 Davinci, GPT-3.5 Turbo, GPT-4, Whisper Transcribe, Whisper Translate | [OpenAI Terms of Use](https://openai.com/terms/)                         |
