...
If your content was impacted by a DMCA notice, and you’d like to make changes or dispute that notice, please contact the Block Protocol _via HASH_ by following the [HASH DMCA counter-notice guide](https://hash.ai/legal/ip/copyright-counter-notice).
