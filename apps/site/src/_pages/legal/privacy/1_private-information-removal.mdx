...
- Content governed by our [Community Guidelines](/legal/community), such as malware or general-purpose tools. If you have questions about our Community Guidelines or believe that content on the Block Protocol might violate our guidelines, you can [contact us](/contact).
...
Due to the type of content the Block Protocol hosts (mostly software code) and the way that content is managed (with Git), we need complaints to be as specific as possible. In order for us to verify that a user has removed reported private information completely, we need to know exactly where to look.
