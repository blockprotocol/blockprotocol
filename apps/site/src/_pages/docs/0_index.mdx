...
- developers who want to [build blocks](https://blockprotocol.org/docs/developing-blocks) and publish them to the [Þ Hub](https://blockprotocol.org/hub)
- developers who want to support [embedding blocks](https://blockprotocol.org/docs/embedding-blocks) within their applications
- users who want to [use blocks](https://blockprotocol.org/docs/using-blocks) within protocol-compliant applications
...
Blocks and types can be published and discovered on the [Þ Hub](https://blockprotocol.org/hub), an open-source registry that anybody can use.
