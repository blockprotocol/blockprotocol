...
- [building block-based applications](https://blockprotocol.org/docs/using-blocks#other-environments) that leverage the Block Protocol
...
The Block Protocol is free to use, and any application can enable the use of Þ blocks by following the [requirements for embedders](https://blockprotocol.org/docs/using-blocks).
