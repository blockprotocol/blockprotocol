...
The messages available for exchange in the graph service are defined in the [service's JSON definition](https://github.com/blockprotocol/blockprotocol/blob/main/packages/%40blockprotocol/hook/src/hook-service.json#L5) and are also
