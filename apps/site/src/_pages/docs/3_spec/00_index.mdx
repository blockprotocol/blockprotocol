...
The [core specification](https://blockprotocol.org/docs/spec/core) sets out how blocks should be defined, how services are defined, how embedding applications should initialize blocks, and _how_ applications and blocks communicate.
...
Separate core and service specifications were introduced in version 0.2 of the Block Protocol.
