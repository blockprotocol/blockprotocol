...
We believe the best blocks will communicate data back and forth with the embedding application, making use of the operations defined in the [Graph Module specification](https://blockprotocol.org/spec/graph-module).
...
To save data beyond the session, blocks should make use of the [operations defined in the spec](https://blockprotocol.org/spec/graph-module) to send updates to the embedding application.
...
and instead have introduced the [Hook Module](https://blockprotocol.org/spec/hook-module) to allow embedding applications to
