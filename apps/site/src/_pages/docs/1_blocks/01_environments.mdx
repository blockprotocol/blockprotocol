...
We aim to ensure that blocks developed in accordance with the Block Protocol spec can be used within GitHub markdown READMEs interactively, and elsewhere on _GitHub.com_. Currently blocks are currently only available for use within GitHub as part of the _GitHub Next_ early release program. We are in the early stages of determining what possible support might look like.
