...
- `aggregateEntities` allows you submit a query which filters the entities in the data store.

You can browse the available entities in order to display them, or create links between them.
