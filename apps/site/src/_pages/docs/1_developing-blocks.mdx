...
Once you've built a block, you can add it to the [Hub](/hub), so that your block will have an instant online demo playground,
...
- add an icon to `public/` and update `blockprotocol.icon` in `package.json`
