...
```js
const nameKey = "https://blockprotocol.org/@blockprotocol/types/property-type/name/";
...
graphModule.createEntity({
  data: {
    entityTypeId: "https://blockprotocol.org/@blockprotocol/types/entity-type/friend/v/1",
    linkData: {
