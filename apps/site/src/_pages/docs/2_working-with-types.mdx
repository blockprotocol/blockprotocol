...
4.  Back on your initial entity type, you can use the link entity type, and then constrain the _destination_ entities of those links by defining a selection of entity types
