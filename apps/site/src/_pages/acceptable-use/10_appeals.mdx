...
In order to prevent unnecessary processing delays, please do not send duplicate requests and be sure to contact us from the email associated with your impacted account if possible. If your content was impacted by a DMCA notice, and you’d like to make changes or dispute that notice, please contact the Block Protocol (via HASH) in accordance with the [HASH DMCA counter-notice guide](https://hash.ai/legal/copyright-dmca-counter-notice).
