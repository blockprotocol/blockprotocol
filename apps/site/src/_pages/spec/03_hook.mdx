...
This document (version 0.3) defines a **hook module** according to the terms set out in the [core specification](https://blockprotocol.org/spec/core).
...
The hook module is dependent on [the graph module](https://blockprotocol.org/spec/graph-module), as it relies on the existence of **entities** – use of the graph module is a prerequisite for use of the hook module.
...
The messages available for exchange in the hook module are defined in the [module's JSON definition](https://blockprotocol.org/spec/hook#message-definitions) and are also
