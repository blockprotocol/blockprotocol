...
The hook module is dependent on [the graph module](https://blockprotocol.org/spec/graph), as it relies on the existence of **entities** – use of the graph module is a prerequisite for use of the hook module.
