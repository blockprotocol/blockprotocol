...
The shared definition of semantic data that blocks and apps use is governed by the standalone [SemType specification](https://semtype.org/spec), which replaces the Graph Module from version 0.4 onwards.
